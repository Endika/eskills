...
- Code, identifiers, log strings, file/var names, UI strings → **English**. Comments minimal — only the non-obvious "why". Watchlist of generated-code tells in `references/code-tells.md`.
